              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      Row(
                        children: [Icon(Icons.local_parking,color: Colors.red), Text("Free Parking")],
                      ),
                      Row(
                        children: [Icon(Icons.credit_card,color: Colors.red,), Text("Credit Cards Accepted")],
                      ),
                      Row(
                        children: [Icon(Icons.wifi,color: Colors.red), Text("WiFi available ")],
                      ),
                    ],
                  ),
                ),
